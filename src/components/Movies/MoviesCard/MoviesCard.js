...
import { MOVIE_LINK } from '../../../utils/constans';
...
//         {location.pathname === '/saved-movies' &&
//           <button type='button' aria-label='удалить фильм' className='card__button' onClick={handleDeleteMovie}>
//             <img className='card__click card__click_delete' alt='удалить' src={deleteButton} />
//           </button>}

//         {location.pathname === '/movies' &&
//           <button type='button' aria-label='сохранить' className='card__button'
//           // onClick={handleSaveMovie}
//           >
//             {/* <img className='card__click' alt='добавлено' src={activeLikeIcon} /> : */}
//             <img className='card__add' alt='добавить' src={baseLikeIcon} /> </button>}
//       </div>
